...
# MAGIC %md
# MAGIC # NCC Rideau Canal Skateway - Ice condition
# MAGIC - [data](https://ncc-hub-ncc-ccn.hub.arcgis.com/datasets/188b2d07708f42b89e50ac2f5b922c1f_0/explore?showTable=true)
...
gdf = gpd.read_file("/Volumes/cjc/geo/data/NCC_Rideau_Canal_Skateway_-_Ice_condition.geojson")
display(gdf)
